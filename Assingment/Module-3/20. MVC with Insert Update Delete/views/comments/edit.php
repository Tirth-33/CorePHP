...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .comment-info { background: #e9ecef; padding: 15px; border-radius: 6px; margin-bottom: 20px; }
        .comment-info small { color: #666; }
    </style>
</head>
<body>
    <div class="container">
        <div class="form-card">
            ...
            <div class="comment-info">
                ...
                <small>Created: <?php echo date('M j, Y g:i A', strtotime($comment['created_at'])); ?></small>
                <?php if ($comment['updated_at'] !== $comment['created_at']): ?>
                    <br><small>Last Updated: <?php echo date('M j, Y g:i A', strtotime($comment['updated_at'])); ?></small>
                <?php endif; ?>
            </div>
            ...
            <form method="POST" action="index.php?action=update&id=<?php echo $comment['id']; ?>">
                <div class="form-group">
                    <label for="name">Name *</label>
                    <input type="text" id="name" name="name" 
                           value="<?php echo htmlspecialchars($_SESSION['old']['name'] ?? $comment['name']); ?>" 
                           required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="email" id="email" name="email" 
                           value="<?php echo htmlspecialchars($_SESSION['old']['email'] ?? $comment['email']); ?>" 
                           required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea id="comment" name="comment" 
                              ...
                              required><?php echo htmlspecialchars($_SESSION['old']['comment'] ?? $comment['comment']); ?></textarea>
                </div>
